...
void cPlPush::getWHY(f32* w, f32* h, f32* dy)
{
    ...
    case 0:
        *w = sx;
        *h = sz;
        *dy = m_Target->ang.y + PI;
        break;
    case 1:
        *w = sz;
        *h = sx;
        *dy = m_Target->ang.y + PI * 0.5f;
        break;
    case 2:
        *w = sx;
        *h = sz;
...
int cPlPush::scrHitCheckSub(f32 w, f32 h, f32 dy, Vec* pos, f32 sign)
{
    Vec v0;
    Vec v1;
    Vec v2;
...
int cPlPush::emSandCheck(f32 w, f32 h, f32 dy, Vec* pos)
{
    Vec v0;
    Vec v1;
    Vec rot;
