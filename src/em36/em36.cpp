...
#ifdef TARGET_PC
static re4_port::BE<u16> em36_flip[120] = {
#else
...
#line 966 "D:/Bio4/Prog/em36.cpp"
    ...
    YarareAdd(em, &w->hit[5], 35.0f, -150.0f, 70.0f, 180.0f, 50.0f, 3, YAT_FLAG_ON);
    YarareAdd(em, &w->hit[6], -35.0f, -150.0f, 70.0f, 180.0f, 50.0f, 3, YAT_FLAG_ON);
    YarareAdd(em, &w->hit[7], 50.0f, 0.0f, 0.0f, 180.0f, 0.0f, 3, YAT_FLAG_ON);
    YarareAdd(em, &w->hit[8], -50.0f, 0.0f, 0.0f, 180.0f, 0.0f, 3, YAT_FLAG_ON);
    YarareAdd(em, &w->hit[9], 70.0f, 125.0f, -60.0f, 130.0f, 0.0f, 3, YAT_FLAG_ON);
    YarareAdd(em, &w->hit[10], -70.0f, 125.0f, -60.0f, 130.0f, 0.0f, 3, YAT_FLAG_ON);
    YarareAdd(em, &w->hit[11], 50.0f, -100.0f, 0.0f, 180.0f, 0.0f, 0x12, YAT_FLAG_ON);
    YarareAdd(em, &w->hit[12], -50.0f, -100.0f, 0.0f, 180.0f, 0.0f, 0x12, YAT_FLAG_ON);
    YarareAdd(em, &w->hit[13], 0.0f, 0.0f, 0.0f, 95.0f, 100.0f, 4, YAT_FLAG_ON);
    YarareAdd(em, &w->hit[14], 0.0f, 10.0f, 30.0f, 110.0f, 80.0f, 5, YAT_FLAG_ON);
    YarareAdd(em, &w->hit[15], 0.0f, 50.0f, -20.0f, 110.0f, 35.0f, 5, YAT_FLAG_ON);
    YarareAdd(em, &w->hit[16], -10.0f, -300.0f, 20.0f, 130.0f, 200.0f, 0x13, YAT_FLAG_ON);
    YarareAdd(em, &w->hit[17], 0.0f, -500.0f, 0.0f, 85.0f, 550.0f, 0x14, YAT_FLAG_ON);
    YarareAdd(em, &w->hit[18], 10.0f, -300.0f, 20.0f, 130.0f, 200.0f, 0x17, YAT_FLAG_ON);
    YarareAdd(em, &w->hit[19], 0.0f, -500.0f, 0.0f, 85.0f, 550.0f, 0x18, YAT_FLAG_ON);
    YarareAdd(em, &w->hit[20], -80.0f, 0.0f, 0.0f, 95.0f, 80.0f, 7, YAT_FLAG_ON | YAT_FLAG_X_AXIS);
    YarareAdd(em, &w->hit[21], -110.0f, 5.0f, 0.0f, 80.0f, 130.0f, 8, YAT_FLAG_ON | YAT_FLAG_X_AXIS);
    YarareAdd(em, &w->hit[22], -230.0f, 5.0f, 5.0f, 78.0f, 200.0f, 9, YAT_FLAG_ON | YAT_FLAG_X_AXIS);
    YarareAdd(em, &w->hit[23], -200.0f, 10.0f, 10.0f, 60.0f, 150.0f, 0xA, YAT_FLAG_ON | YAT_FLAG_X_AXIS);
    YarareAdd(em, &w->hit[24], -50.0f, -10.0f, 15.0f, 80.0f, 0.0f, 0xB, YAT_FLAG_ON | YAT_FLAG_X_AXIS);
    YarareAdd(em, &w->hit[25], 0.0f, 0.0f, 0.0f, 95.0f, 80.0f, 0xD, YAT_FLAG_ON | YAT_FLAG_X_AXIS);
    YarareAdd(em, &w->hit[26], -20.0f, 5.0f, 0.0f, 80.0f, 130.0f, 0xE, YAT_FLAG_ON | YAT_FLAG_X_AXIS);
    YarareAdd(em, &w->hit[27], 30.0f, 5.0f, 5.0f, 78.0f, 200.0f, 0xF, YAT_FLAG_ON | YAT_FLAG_X_AXIS);
...
#define em36CatchEffectDelete(em, w, no) \
    EffectEspDelete(1, (w)->espKind[no], em, 0); \
...
static void em36_R1_CatchHit(cEm36* em)
{
    ...
    case 0:
        ...
        if (!(w->flags2 & 0x10)) {
            EstSet(em, -1, 0, 0, EFF_EM36, 0xB, 1, w->espKind[1], em, 0);
        } else {
            EstSet(em, -1, 0, 0, EFF_EM36, 0x2F, 0, ESP_CORE_KIND_NONE, em, 0);
        }
    ...
    case 2:
        ...
        EstSet(em, -1, 0, 0, EFF_EM36, 9, 1, w->espKind[2], em, 0);
        EstSet(em, -1, 0, 0, EFF_EM36, 0x2D, 0, ESP_CORE_KIND_NONE, em, 0);
        em->r_no_2++;
    case 3:
        if (MotionMove(em, 0)) {
            em->atari.m_flag &= ~8;
    ...
    case 4:
        ...
        EstSet(em, -1, 0, 0, EFF_EM36, 9, 1, w->espKind[2], em, 0);
        EstSet(em, -1, 0, 0, EFF_EM36, 0xC, 0, ESP_CORE_KIND_NONE, em, 0);
        PlGachaInit();
        em->r_no_2++;
    case 5:
        if (MotionMove(em, 0)) {
...
static void em36_R1_D_CatchHit(cEm36* em)
{
    ...
    case 2:
        ...
        EstSet(em, -1, 0, 0, EFF_EM36, 0x2E, 0, ESP_CORE_KIND_NONE, em, 0);
        w->timer = 10;
        em->r_no_2++;
    case 3:
        if (w->timer) {
    ...
    case 4:
        ...
        SndStop(w->sndId, 0);
        em36CatchEffectDelete(em, w, 0);
        EstSet(em, -1, 0, 0, EFF_EM36, 0x2C, 0, ESP_CORE_KIND_NONE, em, 0);
        w->timer = 10;
        em->r_no_2++;
    case 5: {
        int end;
...
static inline void em36DieCore(cEm36* em, int mot0, int mot1)
{
    ...
    case 2:
        w->timer2 = 150;
        w->timer = 0;
        EstSet(em, -1, 0, 0, EFF_EM36, 0x47, 0, ESP_CORE_KIND_NONE, em, 0);
...
int em36LostParts(cEm36* em)
{
    ...
    default: {
        ...
        w->flags2 |= 0x20;
        em36PartsSet(em, 0, 1);
        EstSet(em, -1, 0, 0, EFF_EM36, 1, 0, ESP_CORE_KIND_NONE, em, 0);
        EstSet(em, -1, 0, 0, EFF_EM36, 0x3B, 0, ESP_CORE_KIND_NONE, em, 0);
    ...
    case 1:
        ...
        em36PartsSet(em, 1, 1);
        em36CatchEffectDelete(em, w, 1);
        EstSet(em, -1, 0, 0, EFF_EM36, 0x12, 0, ESP_CORE_KIND_NONE, em, 0);
        SndCall(8, 0x18, &em->pos, em->id, 0, em);
        w->lostTimer = 0x5B;
        w->atkTimer[1] = 450;
        return 1;
    case 2:
        if (!(w->flags2 & 1)) {
            w->flags2 |= 1;
            em36PartsSet(em, 2, 1);
            EstSet(em, -1, 0, 0, EFF_EM36, 0x1B, 0, ESP_CORE_KIND_NONE, em, 0);
            EstSet(em, -1, 0, 0, EFF_EM36, 0x35, 0, ESP_CORE_KIND_NONE, em, 0);
            SndCall(8, 0x18, &em->pos, em->id, 0, em);
            w->lostTimer = 0x5B;
            w->atkTimer[2] = 450;
            return 1;
    ...
    case 3:
        ...
        w->flags2 |= 2;
        em36PartsSet(em, 3, 1);
        EstSet(em, -1, 0, 0, EFF_EM36, 0x1C, 0, ESP_CORE_KIND_NONE, em, 0);
        EstSet(em, -1, 0, 0, EFF_EM36, 0x36, 0, ESP_CORE_KIND_NONE, em, 0);
        SndCall(8, 0x18, &em->pos, em->id, 0, em);
        w->lostTimer = 0x5B;
        w->atkTimer[3] = 450;
        return 1;
    case 4:
        ...
        w->flags2 |= 4;
        em36PartsSet(em, 4, 1);
        EstSet(em, -1, 0, 0, EFF_EM36, 0x1D, 0, ESP_CORE_KIND_NONE, em, 0);
        EstSet(em, -1, 0, 0, EFF_EM36, 0x37, 0, ESP_CORE_KIND_NONE, em, 0);
        SndCall(8, 0x18, &em->pos, em->id, 0, em);
        w->lostTimer = 0x5B;
        w->atkTimer[4] = 450;
        return 1;
    case 5:
        ...
        w->flags2 |= 8;
        em36PartsSet(em, 5, 1);
        EstSet(em, -1, 0, 0, EFF_EM36, 0x1E, 0, ESP_CORE_KIND_NONE, em, 0);
        EstSet(em, -1, 0, 0, EFF_EM36, 0x38, 0, ESP_CORE_KIND_NONE, em, 0);
        SndCall(8, 0x18, &em->pos, em->id, 0, em);
        w->lostTimer = 0x5B;
        w->atkTimer[5] = 450;
        return 1;
...
void em36RegeneCk2(cEm36* em)
{
    ...
    if (w->flags2 & 0x10) {
        if (w->atkTimer[1] == 9) {
            EstSet(em, -1, 0, 0, EFF_EM36, 0x39, 0, ESP_CORE_KIND_NONE, em, 0);
        }
        if (w->atkTimer[1] == 0) {
            w->flags2 &= ~0x10;
            em36PartsSet(em, 1, 0);
    ...
    if (w->flags2 & 0x20) {
        ...
        if (w->atkTimer[0] == 9) {
            EstSet(em, -1, 0, 0, EFF_EM36, 0x3A, 0, ESP_CORE_KIND_NONE, em, 0);
        }
        if (w->atkTimer[0] == 0) {
            w->flags2 &= ~0x20;
            em36PartsSet(em, 0, 0);
...
void em36SetHitMark(cEm36* em, int big)
{
    ...
    EstSet(em, -1, 0, 0, EFF_EM36, kind, 1, w->espKind[3], em, 0);
}
...
void em36RegeneTenMove(cEm36* em)
{
    ...
    for (i = 0; i < 7; i++) {
        ...
        case 0:
            ...
            if (w->atkTimer[0] <= 300) {
                EstSet(em, -1, 0, 0, EFF_EM36, 0x21, 0, ESP_CORE_KIND_NONE, em, 0);
                any = 1;
                if ((u8) (w->frameCnt % 3) == 0) {
                    EstSet(em, -1, 0, 0, EFF_EM36, 0x23, 0, ESP_CORE_KIND_NONE, em, 0);
                }
            } else {
                if ((u8) (w->frameCnt % 3) == 0) {
                    EstSet(em, -1, 0, 0, EFF_EM36, 0x2A, 0, ESP_CORE_KIND_NONE, em, 0);
                }
            }
            if (w->atkTimer[0] != 300) {
                continue;
            ...
            w->tenSeTimer = 29;
            EstSet(em, -1, 0, 0, EFF_EM36, 0x22, 0, ESP_CORE_KIND_NONE, em, 0);
            continue;
        case 1:
            if (!(w->flags2 & 0x10)) {
                continue;
            ...
            if (w->atkTimer[1] <= 300) {
                any = 1;
                if ((u8) (w->frameCnt % 3) == 0) {
                    EstSet(em, -1, 0, 0, EFF_EM36, 0x20, 0, ESP_CORE_KIND_NONE, em, 0);
                }
            } else {
                if ((u8) (w->frameCnt % 3) == 0) {
                    EstSet(em, -1, 0, 0, EFF_EM36, 0x29, 0, ESP_CORE_KIND_NONE, em, 0);
                }
            }
            if (w->atkTimer[1] != 300) {
                continue;
            ...
            SndCall(8, 0x13, &em->pos, em->id, 0, em);
            w->tenSeTimer = 29;
            EstSet(em, -1, 0, 0, EFF_EM36, 0x1F, 0, ESP_CORE_KIND_NONE, em, 0);
            break;
        case 2:
            if (!(w->flags2 & 1)) {
                continue;
            ...
            if (w->atkTimer[2] <= 300) {
                any = 1;
                if ((u8) (w->frameCnt % 3) == 0) {
                    EstSet(em, -1, 0, 0, EFF_EM36, 0x14, 0, ESP_CORE_KIND_NONE, em, 0);
                }
            } else {
                if ((u8) (w->frameCnt % 3) == 0) {
                    EstSet(em, -1, 0, 0, EFF_EM36, 0x25, 0, ESP_CORE_KIND_NONE, em, 0);
                }
            }
            if (w->atkTimer[2] != 300) {
                continue;
            ...
            SndCall(8, 0x13, &em->pos, em->id, 0, em);
            w->tenSeTimer = 29;
            EstSet(em, -1, 0, 0, EFF_EM36, 0x13, 0, ESP_CORE_KIND_NONE, em, 0);
            break;
        case 3:
            if (!(w->flags2 & 2)) {
                continue;
            ...
            if (w->atkTimer[3] <= 300) {
                any = 1;
                if ((u8) (w->frameCnt % 3) == 0) {
                    EstSet(em, -1, 0, 0, EFF_EM36, 0x16, 0, ESP_CORE_KIND_NONE, em, 0);
                }
            } else {
                if ((u8) (w->frameCnt % 3) == 0) {
                    EstSet(em, -1, 0, 0, EFF_EM36, 0x26, 0, ESP_CORE_KIND_NONE, em, 0);
                }
            }
            if (w->atkTimer[3] != 300) {
                continue;
            ...
            SndCall(8, 0x13, &em->pos, em->id, 0, em);
            w->tenSeTimer = 29;
            EstSet(em, -1, 0, 0, EFF_EM36, 0x15, 0, ESP_CORE_KIND_NONE, em, 0);
            break;
        case 4:
            if (!(w->flags2 & 4)) {
                continue;
            ...
            if (w->atkTimer[4] <= 300) {
                any = 1;
                if ((u8) (w->frameCnt % 3) == 0) {
                    EstSet(em, -1, 0, 0, EFF_EM36, 0x18, 0, ESP_CORE_KIND_NONE, em, 0);
                }
            } else {
                if ((u8) (w->frameCnt % 3) == 0) {
                    EstSet(em, -1, 0, 0, EFF_EM36, 0x27, 0, ESP_CORE_KIND_NONE, em, 0);
                }
            }
            if (w->atkTimer[4] != 300) {
                continue;
            ...
            SndCall(8, 0x13, &em->pos, em->id, 0, em);
            w->tenSeTimer = 29;
            EstSet(em, -1, 0, 0, EFF_EM36, 0x17, 0, ESP_CORE_KIND_NONE, em, 0);
            break;
        case 5:
            if (!(w->flags2 & 8)) {
                continue;
            ...
            if (w->atkTimer[5] <= 300) {
                any = 1;
                if ((u8) (w->frameCnt % 3) == 0) {
                    EstSet(em, -1, 0, 0, EFF_EM36, 0x1A, 0, ESP_CORE_KIND_NONE, em, 0);
                }
            } else {
                if ((u8) (w->frameCnt % 3) == 0) {
                    EstSet(em, -1, 0, 0, EFF_EM36, 0x28, 0, ESP_CORE_KIND_NONE, em, 0);
                }
            }
            if (w->atkTimer[5] != 300) {
                continue;
            ...
            SndCall(8, 0x13, &em->pos, em->id, 0, em);
            w->tenSeTimer = 29;
            EstSet(em, -1, 0, 0, EFF_EM36, 0x19, 0, ESP_CORE_KIND_NONE, em, 0);
            break;
        default:
            continue;
        }
    ...
    case 0x27: {
        ...
        if ((Rnd() & 3) == 0) {
            if (EmGetDmPos(em, &pos, &dir)) {
                EstSet(0, -1, &pos, 0, EFF_EM36, 6, 0, ESP_CORE_KIND_NONE, 0, 0);
            }
        }
        break;
    }
